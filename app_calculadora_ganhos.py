...
if st.button("🚀 Calcular Ganhos Potenciais"):
    ...
    st.markdown(
        f"""
        <div style="max-width:630px; padding:10px 45px;
        ...
        border-radius:18px;box-shadow:0 8px 18px rgba(139,0,0,.25);color:#fff;">
          <div style="display:flex;justify-content:space-between;align-items:center">
            <div style="font-weight:300;font-size:30px;">Volume de CR Evitado Estimado</div>
            <div style="font-weight:200;font-size:40px;background:#fff;color:#b31313;
